            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex justify-between gap-4">
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xl font-semibold">{model.phone}</span>
                  </div>
                  <div className="flex items-center  gap-2">
                  ...
                  <div className="flex flex-col w-fit py-4 px-6 rounded-lg items-center bg-primary/10">
                    <span className="text-xl font-semibold">{model.age}</span>
                    <span>Years</span>
                  </div>
                </div>
                ...
                <div className="flex-1 rounded-lg p-4 bg-primary/10">
                  ...
                  <p className="mt-2 font-semibold">
                    Female escort located in Nairobi
                  </p>
              ...
              <div className="border border-primary/20 rounded-lg grid grid-cols-2 gap-2 p-4">
                <div className="flex gap-2 items-center">
                  <span>
                    <ArrowDownLeftSquare className="size-10" />
                  </span>
                ...
                <div className="flex gap-2 items-center">
                  <span>
                    <ArrowUpRightSquare className="size-10" />
                  </span>
                  <div className="flex flex-col">
                    <span className="font-semibold text-sm">
