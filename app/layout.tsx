    ...
    <html lang="en" suppressHydrationWarning>
      ...
      >
        <ReactQueryProvider>
          ...
          <div className="flex flex-col min-h-screen bg-zinc-50 dark:bg-black font-sans w-dvw ">
            ...
            <div className="flex flex-col flex-1 w-dvw relative">
              {/* Sticky image container - removed absolute positioning */}
              <div className="absolute top-30 md:-left-25 opacity-5 z-0 pointer-events-none">
                <Image
              ...
              <div className="fixed top-30 md:-right-25 opacity-5 z-0 pointer-events-none">
                <Image
